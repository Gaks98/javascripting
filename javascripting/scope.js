...
* outside a
* function definition is a global variable, and its value is
* accessible and modifiable throughout your program.A variable that is
* declared inside a
* function definition is local.It is created and
* destroyed every time the
* function is executed, and it cannot be accessed
* by any code outside the
* function.
...
IIFE, Immediately Invoked Function Expression, is a common pattern
for
